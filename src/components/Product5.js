import softwareDetails from './Software'
...
const product5 = () => {
    return (
        <div>
            ...
            <div>
               <center><h1 className='cdiv' style={{padding:"10px",marginBottom:"40px"}}>Software</h1></center>
            </div>
            <div>
                {
                    softwareDetails.length > 0 ? <div  style={{display:"flex",justifyContent:"space-between",flexWrap:"wrap",margin:"0px auto", height: "auto",width:"95%" }}>
                        {
                            softwareDetails.map((item, index) => <div style={{marginBottom:"20px"}} key={index}>
