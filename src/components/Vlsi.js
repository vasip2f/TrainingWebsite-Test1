...
import React from "react";
import content from "./content.module.css";
import atmImg from "../images/VLSI_IMAGE.jpg";
...
function Vlsi() {
  return (
    <div className={content.body}>
     ...
     <div className={Vlsi.Content}>
      ...
      <div>
        ...
        <br></br>
        <p className={content.para}>
        VLSI is one of the most widely used technologies for microchip processors, integrated circuits (IC) and component designing. 
   It was initially designed to support hundreds of thousands of transistor gates on a microchip which, as of 2012, exceeded several billion.
   All of these transistors are remarkably integrated and embedded within a microchip that has shrunk over time but still has the capacity to hold enormous amounts of transistors.
   ...
   design metrics MOS Devices, CMOS Inverter
...
// const rootElement = document.getElementById("root");
// ReactDOM.render(<Vlsi />, rootElement);
