...
import React from "react";
import content from "./content.module.css";
import atmImg from "../images/data_analysis.jpg";
...
function DataAnalysis() {
  return (
    <div className={content.body}>
      ...
      <div className={content.Rating}>
        <div className={content.Jdiscription}>
          <b><h1>DataAnalysis for Beginners</h1></b>
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <div className={DataAnalysis.Content}>
      ...
      <div>
        ...
        Data analysis is used to evaluate data with statistical tools to discover useful information. 
        </p>
        <br></br>
        <div className={content.Jdiscription}>
          <h2>What We'll Learn Here</h2>
...
// const rootElement = document.getElementById("root");
// ReactDOM.render(<DataAnalysis/>, rootElement);
