...
import React from "react";
import content from "./content.module.css";
import atmImg from "../images/MEAN_image.png";
...
function Meanstack() {
  return (
    <div className={content.body}>
      ...
      <div className={content.Rating}>
        <div className={content.Jdiscription}>
          <b><h1>MEAN Stack for Beginners</h1></b>
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <div className={Meanstack.Content}>
...
Retrieving Data using AJAX, JSON & XML.Angular routes and router service, Angular forms, Using custom input and output
property binding, ngFor structural directives, async pipe and the observables, unit
testing.
        </p>
        <br></br>
        ...
        <br></br>
        <p className={content.para}>
        Environment Setup, Internals, Module System, Package Management, File I/O, Web Servers, Express Framework, REST API and Testing APIs.
      Databases – SQL and NoSQL, Security & Authentication, Sockets with Node.js.
      Introduction to Scalable Systems, Distributed Systems, Building Blocks of Scalable Structure and Introduction to Design Patterns.
        </p>
        <br></br>
        <div className={content.Jdiscription}>
          <h2>What We'll Learn Here</h2>
...
// const rootElement = document.getElementById("root");
// ReactDOM.render(<Meanstack />, rootElement);
